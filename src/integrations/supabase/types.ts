  ...
  public: {
    Tables: {
      ...
      utility_bill_anomalies: {
        ...
        Relationships: [
          {
            foreignKeyName: "utility_bill_anomalies_utility_bill_id_fkey"
      ...
      utility_bill_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "utility_bill_documents_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "utility_bill_documents_utility_bill_id_fkey"
            columns: ["utility_bill_id"]
            isOneToOne: false
            referencedRelation: "utility_bills"
            referencedColumns: ["id"]
      ...
      utility_data_extractions: {
        ...
        Relationships: [
          {
            foreignKeyName: "utility_data_extractions_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "property_documents"
            referencedColumns: ["id"]

...
import { Calendar as CalendarIcon, FileText, Banknote, PieChart, ArrowUpDown, Building, GitCompare } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      <Card className="overflow-hidden">
        ...
        <CardContent className="pt-6">
          ...
          {/* Detailed Information - Only show when not in comparison mode */}
          {!showComparison && (

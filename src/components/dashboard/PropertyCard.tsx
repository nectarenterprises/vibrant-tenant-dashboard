...
const PropertyCard: React.FC<PropertyCardProps> = ({ property, delay = 0 }) => {
  ...
  return (
    <div 
      className={cn(
        "rounded-xl overflow-hidden card-gradient shadow-md hover:shadow-xl transition-all duration-300 animate-fade-in h-full flex flex-col cursor-pointer",
    ...
    >
      <div 
        className="h-40 mellow-gradient relative"
      >
